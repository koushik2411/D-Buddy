...
function BmiCalculator() {
  ...
  return (
    <div className=" p-3 pt-15 flex items-start justify-center">
      ...
      <div className=" p-1 w-full max-w-100 flex flex-col items-center gap-5 bg-slate-200/65 rounded-xl shadow-xl">

        <h1 className=' w-full px-2 py-4 text-2xl font-semibold bg-linear-to-b from-slate-600 to-slate-800 rounded-t-xl text-center text-slate-200'>BMI CALCULATOR</h1>
        ...
        <div className=" p-3 w-full flex flex-col gap-3">
          ...
          <button onClick={calculateBmi} className=" mt-3 p-2 bg-linear-to-b from-slate-500 to-slate-700 rounded text-slate-200 active:scale-[0.98]">Calculate BMI</button>
